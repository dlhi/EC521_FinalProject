...
# sys.path.append('/home/rjewing/Schoolwork/current/EC521/project/xbmctopython')
# from KodiImporter import KodiScriptImporter as ksi
# importer = ksi.KodiScriptImporter(kodi='/home/rjewing/Schoolwork/fall18/EC521/project/kodi/addons', kodi_home='/home/rjewing/.kodi/addons/')
# importer.install()
...
def parseAST(filename, variable_key):
    ...
    locals()[filename[:-3]] = importlib.import_module(f[:-3])
